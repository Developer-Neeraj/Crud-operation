...
<body>
    ...
    <h2 class="text-danger my-4 text-center">UPDATE STUDENT RECORD</h2>
    ...
    <div class="container my-4">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="my-4">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="hidden" class="form-control" id="name" hidden name="id" placeholder="Name" value="<?php echo $row['id']; ?>">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $row['sname']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="last" class="col-sm-2 col-form-label">LAST NAME</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="last" id="last" placeholder="Last Name" value="<?php echo $row['last_name']; ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <?php
                        echo '<select id="course" class="form-control" name="course">';
                        $sl = "SELECT * FROM exam";
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <button name="create" class="btn btn-outline-success">CREATE</button>
                </div>
            </div>
